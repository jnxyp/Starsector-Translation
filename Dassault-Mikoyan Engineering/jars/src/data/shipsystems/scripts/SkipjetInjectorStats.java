...
public class SkipjetInjectorStats extends BaseShipSystemScript
{
    ...
    private static final float PARTICLE_BASE_DURATION = 0.3f;
    ...
    private static final float PARTICLE_VELOCITY_MULT = 0.005f;
