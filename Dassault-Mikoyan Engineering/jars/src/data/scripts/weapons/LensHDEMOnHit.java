 ...
 */
public class LensHDEMOnHit implements OnHitEffectPlugin
{
    ...
    // It can be changed
    private static final Color EXPLOSION_COLOR = new Color(105,255,155,255);
    ...
    private static final Color PARTICLE_COLOR = new Color(105,255,155,255);
            ...
            CombatEngineAPI engine)
    {
        ...
        if (target instanceof ShipAPI && !shieldHit && Math.random() <= CRIT_CHANCE)
        {
            ...
            engine.spawnExplosion(point,
                    ...
                    0.5f // how long the explosion lingers for
            );
