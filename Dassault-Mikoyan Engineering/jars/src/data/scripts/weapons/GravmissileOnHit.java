 ...
 */
public class GravmissileOnHit implements OnHitEffectPlugin
{
    ...
    // It can be changed
    // private static final Color EXPLOSION_COLOR = new Color(215,215,200,225);
    private static final Color EXPLOSION_COLOR = new Color(215, 215, 200, 225);
            ...
            CombatEngineAPI engine)
    {
        ...
        if (target instanceof ShipAPI && !shieldHit)
        {
            ...
            engine.spawnExplosion(point, v_target,
                    ...
                    1.5f // how long the explosion lingers for
            );
        }
    }
