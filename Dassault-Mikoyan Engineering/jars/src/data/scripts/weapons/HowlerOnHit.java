 ...
 */
public class HowlerOnHit implements OnHitEffectPlugin
{
    ...
    private static final int CRIT_DAMAGE_MAX = 75;
    ...
    private static final Color PARTICLE_COLOR = new Color(255, 150, 100, 225);
