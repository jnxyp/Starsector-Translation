 ...
 */
public class RailSparks12cm implements OnHitEffectPlugin
{

    // likelihood of creating sparks (0 - 1)
    private static final float SPARK_CHANCE = 1.0f;
    ...
    private static final float CONE_ANGLE = 215f;
    // constant that effects the lower end of the particle velocity
    private static final float VEL_MIN = 0.175f;
