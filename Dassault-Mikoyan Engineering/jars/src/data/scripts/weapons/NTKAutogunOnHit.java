 ...
 */
public class NTKAutogunOnHit implements OnHitEffectPlugin
{
    ...
    private static final int CRIT_DAMAGE_MIN = 30;
    // maximum amount of extra damage dealt
    private static final int CRIT_DAMAGE_MAX = 60;
    ...
    // It can be changed
    // private static final Color EXPLOSION_COLOR = new Color(215,150,75,255);
    private static final Color EXPLOSION_COLOR = new Color(215, 150, 75, 255);
            ...
            CombatEngineAPI engine)
    {
        ...
        if (target instanceof ShipAPI && !shieldHit && Math.random() <= CRIT_CHANCE)
        {
            ...
            engine.spawnExplosion(point, v_target,
                    ...
                    0.45f // how long the explosion lingers for
            );
        }
    }
